...
public class OceanicBiomeModifier implements BiomeModifier
{
	...
	public void modify(Holder<Biome> biome, Phase phase, Builder builder)
	{
		...
		{
			mobSpawnSettings.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(OceanicEntities.CRAB.get(), 40, 1, 4));
		}
		if(biome.is(Biomes.COLD_OCEAN) || biome.is(Biomes.DEEP_COLD_OCEAN))
		{
			...
			mobSpawnSettings.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(OceanicEntities.TUNA.get(), 20, 1, 1));
		}
		if(biome.is(Biomes.WARM_OCEAN) || biome.is(Biomes.LUKEWARM_OCEAN) || biome.is(Biomes.DEEP_LUKEWARM_OCEAN))
		{
			mobSpawnSettings.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(OceanicEntities.DOLPHINFISH.get(), 20, 1, 1));
		}
	}
