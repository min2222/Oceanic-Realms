...
public class SeaAnemoneFeature extends Feature<NoneFeatureConfiguration>
{
	public SeaAnemoneFeature(Codec<NoneFeatureConfiguration> p_65786_)
	{
		super(p_65786_);
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> p_159749_) 
	{
		...
		if(random.nextFloat() <= this.getChance(biome, state))
		{
			...
			{
				BlockState blockState = OceanicBlocks.SEA_ANEMONE.get().defaultBlockState().setValue(SeaAnemoneBlock.VARIANT, random.nextInt(1, 4)).setValue(SeaAnemoneBlock.IS_WARM, biome.is(OceanicTags.OceanicBiomes.WARM_OCEANS));
