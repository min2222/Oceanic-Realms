...
import com.min01.oceanicrealms.block.SeaUrchinBlock;
...
{
	public SeaUrchinFeature(Codec<NoneFeatureConfiguration> p_65786_)
	{
		super(p_65786_);
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> p_159749_) 
	{
		...
		if(random.nextFloat() <= this.getChance(biome, state))
		{
			...
			{
				level.setBlock(pos, OceanicBlocks.SEA_URCHIN.get().defaultBlockState().setValue(SeaUrchinBlock.VARIANT, random.nextInt(1, 5)), 2);
				return true;
			}
		}
		return false;
