...
public class ReefRockBeachFeature extends Feature<ListFeatureConfiguration>
{
	public ReefRockBeachFeature(Codec<ListFeatureConfiguration> p_65786_) 
	{
		super(p_65786_);
	}
	...
	public boolean place(FeaturePlaceContext<ListFeatureConfiguration> p_159749_)
	{
		...
		if(level.getBlockState(pos.below()).is(Blocks.SAND))
		{
			...
			{
				ResourceLocation location = p_159749_.config().structures.get(random.nextInt(6));
