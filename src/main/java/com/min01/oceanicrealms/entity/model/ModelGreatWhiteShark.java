...
public class ModelGreatWhiteShark extends HierarchicalModel<EntityGreatWhiteShark>
{
	...
	public static LayerDefinition createBodyLayer() 
	{
		...
		bone8.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(126, 129).addBox(-1.0F, -18.0F, 11.0F, 2.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1745F, 0.0F, 0.0F));
		...
		bone12.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(99, 130).addBox(-1.0F, -27.0F, -14.0F, 2.0F, 5.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.364F, 8.364F, -0.7854F, 0.0F, 0.0F));

		bone12.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(119, 17).addBox(-1.0F, -22.0F, -5.0F, 2.0F, 27.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.0F, -0.7854F, 0.0F, 0.0F));

		bone12.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -33.0F, 4.0F, 2.0F, 8.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 20.5061F, -19.9203F, -0.7854F, 0.0F, 0.0F));
		...
		bone2.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(34, 121).addBox(-1.0F, -34.0F, 4.0F, 2.0F, 19.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1745F, 0.0F, 0.0F));
