...
import com.min01.oceanicrealms.entity.animation.BullSharkAnimation;
...
public class ModelBullShark extends HierarchicalModel<EntityBullShark>
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(OceanicRealms.MODID, "bull_shark"), "main");
	...
	public static LayerDefinition createBodyLayer() 
	{
		...
		PartDefinition bone = root.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -7.0F, -10.0F, 12.0F, 14.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, 1.0F));
		...
		PartDefinition bone2 = bone.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(38, 32).addBox(-5.0F, -5.0F, 0.0F, 10.0F, 10.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 8.0F));
		...
		PartDefinition bone3 = bone2.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(0, 57).addBox(-2.0F, -2.0F, 0.0F, 4.0F, 5.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 7.0F));

		PartDefinition bone11 = bone3.addOrReplaceChild("bone11", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 6.0F));

		bone11.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(60, 20).addBox(-1.5F, 0.0F, 0.0F, 1.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.0F, 5.6569F, -0.7854F, 0.0F, 0.0F));
	...
	@Override
	public void setupAnim(EntityBullShark entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) 
	{
		this.root().getAllParts().forEach(ModelPart::resetPose);
		OceanicClientUtil.animateHead(this.root, netHeadYaw, headPitch);
		this.root.zRot += Math.toRadians(entity.getRollAngle());
		this.animateWalk(BullSharkAnimation.BULL_SHARK_SWIM, limbSwing, limbSwingAmount, 2.5F, 2.5F);
		this.animate(entity.attackAnimationState, BullSharkAnimation.BULL_SHARK_ATTACK, ageInTicks);
		this.animate(entity.eatingAnimationState, BullSharkAnimation.BULL_SHARK_EATING, ageInTicks);
	}
