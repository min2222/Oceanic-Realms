...
public class ModelWhaleshark extends HierarchicalModel<EntityWhaleshark>
{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition bone2 = bone.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(0, 142).addBox(-16.0F, -14.0F, 0.0F, 32.0F, 28.0F, 38.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 23.0F));
	...
	public void setupAnim(EntityWhaleshark entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) 
	{
		...
		OceanicClientUtil.animateHead(this.bone2, rot.y - netHeadYaw - yBodyRot, rot.x - headPitch);
