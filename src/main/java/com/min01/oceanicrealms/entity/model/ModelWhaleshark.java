...
public class ModelWhaleshark extends HierarchicalModel<EntityWhaleshark>
{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		front_body.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(36, 289).mirror().addBox(-40.0F, -2.0F, -7.0F, 40.0F, 3.0F, 19.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-24.0F, 11.0F, 4.0F, 0.1309F, 0.1309F, -0.4363F));
		...
		bone3.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(158, 118).addBox(-1.0F, -8.0F, -1.0F, 2.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -11.0F, 20.0F, -0.1745F, 0.0F, 0.0F));

		PartDefinition bone4 = bone3.addOrReplaceChild("bone4", CubeListBuilder.create(), PartPose.offset(0.0F, -2.0F, 31.0F));

		bone4.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(158, 81).addBox(-2.0F, -14.0F, -20.0F, 4.0F, 14.0F, 23.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 26.8492F, 26.8492F, -0.7854F, 0.0F, 0.0F));

		bone4.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(186, 0).addBox(-2.0F, -53.0F, -17.0F, 4.0F, 53.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 12.0F, 12.0F, -0.7854F, 0.0F, 0.0F));
