...
public class ModelWhaleshark extends HierarchicalModel<EntityWhaleshark>
{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition bone = root.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 0).addBox(-24.0F, -36.0F, -23.0F, 48.0F, 36.0F, 45.0F, new CubeDeformation(0.0F))
		.texOffs(260, 84).addBox(-21.0F, -33.0F, -60.0F, 42.0F, 28.0F, 37.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		bone.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(36, 289).addBox(0.0F, -2.0F, -7.0F, 40.0F, 3.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(24.0F, -7.0F, 3.0F, 0.1309F, -0.1309F, 0.4363F));

		bone.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(36, 289).mirror().addBox(-40.0F, -2.0F, -7.0F, 40.0F, 3.0F, 19.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-24.0F, -7.0F, 3.0F, 0.1309F, 0.1309F, -0.4363F));
