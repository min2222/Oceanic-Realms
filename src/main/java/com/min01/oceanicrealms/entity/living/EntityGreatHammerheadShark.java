...
public class EntityGreatHammerheadShark extends AbstractOceanicShark
{	
	public final AnimationState attackAnimationState = new AnimationState();
	public final AnimationState eatingAnimationState = new AnimationState();
	
	public EntityGreatHammerheadShark(EntityType<? extends AbstractOceanicShark> p_33002_, Level p_33003_) 
	{
    ...
    protected void registerGoals() 
    {
    	...
    	this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, WaterAnimal.class, false, OceanicUtil.TARGET_PREDICATE2)
    	{
    		...
    		{
    			return super.canUse() && EntityGreatHammerheadShark.this.isHungry();
    		}
    	});
