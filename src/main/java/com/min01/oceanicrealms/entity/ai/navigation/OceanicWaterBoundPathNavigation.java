package com.min01.oceanicrealms.entity.ai.navigation;
...
//https://github.com/AlexModGuy/AlexsCaves/blob/main/src/main/java/com/github/alexmodguy/alexscaves/server/entity/ai/SemiAquaticPathNavigatorNoSpin.java
public class OceanicWaterBoundPathNavigation extends WaterBoundPathNavigation
{
    private float distancemodifier = 0.75F;
    
    public OceanicWaterBoundPathNavigation(Mob entity, Level world) 
    {
        super(entity, world);
    }

    public OceanicWaterBoundPathNavigation(Mob entitylivingIn, Level worldIn, float distancemodifier) 
    {
    ...
    protected void followThePath() 
    {
        ...
        this.maxDistanceToWaypoint = this.mob.getBbWidth() * this.getDistanceModifier();
